...
<div class="container mt-5">
                ...
                <div class="card border-info">
                    <div class="card-body">
                        ...
                        <ul class="mb-0 ps-3 small">
                            ...
                            <hr>
                            <li>Sending google forms will put the application on pending status. (Sends an email to the applicant with the google forms link)</li>
    ...
    <h2 class="mb-4">Initial Applications</h2>

    <!-- Unified Filter Form -->
    <form method="GET" action="{{ route('admin.applicants') }}">
        <div class="row mb-3">
            <!-- Search Input -->
            ...
            <tbody>
                @forelse($applicants as $applicant)
                    <tr>
                        ...
                        <form method="POST" action="{{ route('admin.applicants.action') }}">
                            @csrf
                            <td>
                                ...
                                <select name="selectedAction" class="form-select" required>
                                    ...
                                    <option value="pending">Send Google Forms</option>
